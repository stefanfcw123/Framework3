...
namespace XLua.CSObjectWrap
{
    ...
    public class DGTweeningDOVirtualWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "Vector3", _m_Vector3_xlua_st_);
        ...
        static int _m_Int_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                    DG.Tweening.TweenCallback<int> _onVirtualUpdate = translator.GetDelegate<DG.Tweening.TweenCallback<int>>(L, 4);
                    
                        DG.Tweening.Tweener gen_ret = DG.Tweening.DOVirtual.Int( _from, _to, _duration, _onVirtualUpdate );
                        translator.Push(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_Vector3_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                    DG.Tweening.TweenCallback<UnityEngine.Vector3> _onVirtualUpdate = translator.GetDelegate<DG.Tweening.TweenCallback<UnityEngine.Vector3>>(L, 4);
                    
                        DG.Tweening.Tweener gen_ret = DG.Tweening.DOVirtual.Vector3( _from, _to, _duration, _onVirtualUpdate );
                        translator.Push(L, gen_ret);
        ...
        static int _m_Color_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                    DG.Tweening.TweenCallback<UnityEngine.Color> _onVirtualUpdate = translator.GetDelegate<DG.Tweening.TweenCallback<UnityEngine.Color>>(L, 4);
                    
                        DG.Tweening.Tweener gen_ret = DG.Tweening.DOVirtual.Color( _from, _to, _duration, _onVirtualUpdate );
                        translator.Push(L, gen_ret);

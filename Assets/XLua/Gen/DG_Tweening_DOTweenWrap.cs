...
namespace XLua.CSObjectWrap
{
    ...
    public class DGTweeningDOTweenWrap 
    {
        public static void __Register(RealStatePtr L)
        {
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 46, 22, 22);
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "TotalActiveTweens", _m_TotalActiveTweens_xlua_st_);
            ...
            Utils.RegisterFunc(L, Utils.CLS_GETTER_IDX, "safeModeLogBehaviour", _g_get_safeModeLogBehaviour);
            ...
            Utils.RegisterFunc(L, Utils.CLS_SETTER_IDX, "safeModeLogBehaviour", _s_set_safeModeLogBehaviour);
		    ...
		    try {
                ...
                if(gen_param_count == 4&& translator.Assignable<DG.Tweening.Core.DOGetter<int>>(L, 1)&& translator.Assignable<DG.Tweening.Core.DOSetter<int>>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        DG.Tweening.Core.TweenerCore<int, int, DG.Tweening.Plugins.Options.NoOptions> gen_ret = DG.Tweening.DOTween.To( _getter, _setter, _endValue, _duration );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 4&& translator.Assignable<DG.Tweening.Core.DOGetter<uint>>(L, 1)&& translator.Assignable<DG.Tweening.Core.DOSetter<uint>>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        DG.Tweening.Core.TweenerCore<uint, uint, DG.Tweening.Plugins.Options.UintOptions> gen_ret = DG.Tweening.DOTween.To( _getter, _setter, _endValue, _duration );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 4&& translator.Assignable<DG.Tweening.Core.DOGetter<long>>(L, 1)&& translator.Assignable<DG.Tweening.Core.DOSetter<long>>(L, 2)&& (LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3) || LuaAPI.lua_isint64(L, 3))&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        DG.Tweening.Core.TweenerCore<long, long, DG.Tweening.Plugins.Options.NoOptions> gen_ret = DG.Tweening.DOTween.To( _getter, _setter, _endValue, _duration );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 4&& translator.Assignable<DG.Tweening.Core.DOGetter<ulong>>(L, 1)&& translator.Assignable<DG.Tweening.Core.DOSetter<ulong>>(L, 2)&& (LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3) || LuaAPI.lua_isuint64(L, 3))&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        DG.Tweening.Core.TweenerCore<ulong, ulong, DG.Tweening.Plugins.Options.NoOptions> gen_ret = DG.Tweening.DOTween.To( _getter, _setter, _endValue, _duration );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        DG.Tweening.Core.TweenerCore<UnityEngine.Color, UnityEngine.Color, DG.Tweening.Plugins.Options.ColorOptions> gen_ret = DG.Tweening.DOTween.ToAlpha( _getter, _setter, _endValue, _duration );
                        translator.Push(L, gen_ret);
        ...
        static int _m_Sequence_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 1&& translator.Assignable<object>(L, 1)) 
                {
                    object _target = translator.GetObject(L, 1, typeof(object));
                        ...
                        DG.Tweening.Sequence gen_ret = DG.Tweening.DOTween.Sequence( _target );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.DOTween.Sequence!");
		    ...
		    try {
                ...
                if(gen_param_count == 3&& translator.Assignable<object>(L, 1)&& translator.Assignable<object>(L, 2)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    bool _complete = LuaAPI.lua_toboolean(L, 3);
                        ...
                        int gen_ret = DG.Tweening.DOTween.Kill( _target, _id, _complete );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
                ...
                if(gen_param_count == 2&& translator.Assignable<object>(L, 1)&& translator.Assignable<object>(L, 2)) 
                {
                    ...
                    object _id = translator.GetObject(L, 2, typeof(object));
                        ...
                        int gen_ret = DG.Tweening.DOTween.Kill( _target, _id );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_TotalActiveTweens_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        int gen_ret = DG.Tweening.DOTween.TotalActiveTweens(  );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_safeModeLogBehaviour(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, DG.Tweening.DOTween.safeModeLogBehaviour);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_nestedTweenFailureBehaviour(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, DG.Tweening.DOTween.nestedTweenFailureBehaviour);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_onWillLog(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, DG.Tweening.DOTween.onWillLog);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_safeModeLogBehaviour(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			DG.Tweening.Core.Enums.SafeModeLogBehaviour gen_value;translator.Get(L, 1, out gen_value);
				DG.Tweening.DOTween.safeModeLogBehaviour = gen_value;
        ...
        static int _s_set_nestedTweenFailureBehaviour(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			DG.Tweening.Core.Enums.NestedTweenFailureBehaviour gen_value;translator.Get(L, 1, out gen_value);
				DG.Tweening.DOTween.nestedTweenFailureBehaviour = gen_value;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_onWillLog(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    DG.Tweening.DOTween.onWillLog = translator.GetDelegate<System.Func<UnityEngine.LogType, object, bool>>(L, 1);

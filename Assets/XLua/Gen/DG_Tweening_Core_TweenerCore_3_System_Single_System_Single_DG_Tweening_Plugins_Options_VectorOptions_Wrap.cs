...
namespace XLua.CSObjectWrap
{
    ...
    public class DGTweeningCoreTweenerCore_3_SystemSingleSystemSingleDGTweeningPluginsOptionsVectorOptions_Wrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.VectorOptions>);
        ...
        {
            return LuaAPI.luaL_error(L, "DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.VectorOptions> does not have a constructor!");
        }
        ...
        static int _m_ChangeStartValue(RealStatePtr L)
        {
		    try {
                ...
                DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.VectorOptions> gen_to_be_invoked = (DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.VectorOptions>)translator.FastGetCSObj(L, 1);
                ...
                {
                    float _newStartValue = (float)LuaAPI.lua_tonumber(L, 2);
                    float _newDuration = (float)LuaAPI.lua_tonumber(L, 3);
                    
                        DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.VectorOptions> gen_ret = gen_to_be_invoked.ChangeStartValue( _newStartValue, _newDuration );
                ...
                if(gen_param_count == 2&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)) 
                {
                    float _newStartValue = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.VectorOptions> gen_ret = gen_to_be_invoked.ChangeStartValue( _newStartValue );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.VectorOptions>.ChangeStartValue!");
        ...
        static int _m_ChangeEndValue(RealStatePtr L)
        {
		    try {
                ...
                {
                    float _newEndValue = (float)LuaAPI.lua_tonumber(L, 2);
                    bool _snapStartValue = LuaAPI.lua_toboolean(L, 3);
                    
                        DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.VectorOptions> gen_ret = gen_to_be_invoked.ChangeEndValue( _newEndValue, _snapStartValue );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _snapStartValue = LuaAPI.lua_toboolean(L, 4);
                        ...
                        DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.VectorOptions> gen_ret = gen_to_be_invoked.ChangeEndValue( _newEndValue, _newDuration, _snapStartValue );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _newDuration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.VectorOptions> gen_ret = gen_to_be_invoked.ChangeEndValue( _newEndValue, _newDuration );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 2&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)) 
                {
                    float _newEndValue = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.VectorOptions> gen_ret = gen_to_be_invoked.ChangeEndValue( _newEndValue );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.VectorOptions>.ChangeEndValue!");
        ...
        static int _m_ChangeValues(RealStatePtr L)
        {
		    try {
                ...
                {
                    float _newStartValue = (float)LuaAPI.lua_tonumber(L, 2);
                    float _newEndValue = (float)LuaAPI.lua_tonumber(L, 3);
                    float _newDuration = (float)LuaAPI.lua_tonumber(L, 4);
                    
                        DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.VectorOptions> gen_ret = gen_to_be_invoked.ChangeValues( _newStartValue, _newEndValue, _newDuration );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _newEndValue = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.VectorOptions> gen_ret = gen_to_be_invoked.ChangeValues( _newStartValue, _newEndValue );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.VectorOptions>.ChangeValues!");
        ...
        static int _m_SetAutoKill(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.VectorOptions>.SetAutoKill!");
        ...
        static int _m_SetId(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.VectorOptions>.SetId!");
        ...
        static int _m_SetLink(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.VectorOptions>.SetLink!");
        ...
        static int _m_SetLoops(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.VectorOptions>.SetLoops!");
        ...
        static int _m_SetEase(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.VectorOptions>.SetEase!");
        ...
        static int _m_SetRecyclable(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.VectorOptions>.SetRecyclable!");
        ...
        static int _m_SetUpdate(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.VectorOptions>.SetUpdate!");
        ...
        static int _m_SetInverted(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.VectorOptions>.SetInverted!");
        ...
        static int _m_SetAs(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.VectorOptions>.SetAs!");
        ...
        static int _m_From(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.VectorOptions>.From!");
        ...
        static int _m_SetDelay(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.VectorOptions>.SetDelay!");
        ...
        static int _m_SetRelative(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.VectorOptions>.SetRelative!");
        ...
        static int _m_SetSpeedBased(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.VectorOptions>.SetSpeedBased!");
        ...
        static int _g_get_startValue(RealStatePtr L)
        {
		    try {
                ...
                DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.VectorOptions> gen_to_be_invoked = (DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.VectorOptions>)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushnumber(L, gen_to_be_invoked.startValue);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_endValue(RealStatePtr L)
        {
		    try {
                ...
                DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.VectorOptions> gen_to_be_invoked = (DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.VectorOptions>)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushnumber(L, gen_to_be_invoked.endValue);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_changeValue(RealStatePtr L)
        {
		    try {
                ...
                DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.VectorOptions> gen_to_be_invoked = (DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.VectorOptions>)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushnumber(L, gen_to_be_invoked.changeValue);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_startValue(RealStatePtr L)
        {
		    try {
                ...
                DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.VectorOptions> gen_to_be_invoked = (DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.VectorOptions>)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.startValue = (float)LuaAPI.lua_tonumber(L, 2);
        ...
        static int _s_set_endValue(RealStatePtr L)
        {
		    try {
                ...
                DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.VectorOptions> gen_to_be_invoked = (DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.VectorOptions>)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.endValue = (float)LuaAPI.lua_tonumber(L, 2);
        ...
        static int _s_set_changeValue(RealStatePtr L)
        {
		    try {
                ...
                DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.VectorOptions> gen_to_be_invoked = (DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.VectorOptions>)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.changeValue = (float)LuaAPI.lua_tonumber(L, 2);
        ...
        static int _s_set_getter(RealStatePtr L)
        {
		    try {
                ...
                DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.VectorOptions> gen_to_be_invoked = (DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.VectorOptions>)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.getter = translator.GetDelegate<DG.Tweening.Core.DOGetter<float>>(L, 2);
        ...
        static int _s_set_setter(RealStatePtr L)
        {
		    try {
                ...
                DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.VectorOptions> gen_to_be_invoked = (DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.VectorOptions>)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.setter = translator.GetDelegate<DG.Tweening.Core.DOSetter<float>>(L, 2);
